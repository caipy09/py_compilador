...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','calc.py',53),
  ...
  ('expression -> - expression','expression',2,'p_expression_uminus','calc.py',78),
  ('expression -> ( expression )','expression',3,'p_expression_group','calc.py',83),
  ('expression -> NUMBER','expression',1,'p_expression_number','calc.py',88),
